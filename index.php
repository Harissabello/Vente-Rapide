...
<body>
    ...
    <header>
        <div class="bloc1">
            ...
            <form method="POST">
                <input type="text" id="rech" class="rec" name="fonction" placeholder="Search..." onkeup="search()">
                <button type="button" id="output"> <img
            ...
            <form method="POST" action="">
                <div class="fil">
                    ...
                    <select name="fonction" id="fil" style="border-style: none;font-weight: bold;">
                        ...
                        <option value="ceréale">Céréale</option>
                        <option value="legumineuse">Légumineuse</option>
                        <option value="tubercule">Turbercule</option>
                    </select>
...
?>
    ...
    <section id="deuxieme" style="width: 100%;padding-top: 20px; padding-right: 30px; margin-left: 80px;">
        <?php
    ...
    ?>
        <div style="display: inline-flex;justify-content: space-around;margin-left: 10px;margin-bottom:10px">
            ...
            <div class="gallery">
                ...
                <div class="bloac">
                    <p class="para"><?=$har['detailsProduits']?></p>
                    <p class="para1">Prix: <strong><?=$har['prixP']?> FCFA </strong></p>
                </div>
                <div class="lien">
                    <?php
            $myId = $har['user_id'];
